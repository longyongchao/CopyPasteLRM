...
if __name__ == "__main__":
    ...
    path = "results/resamples_-1/seed_42/tpr_0.7-tpp_0.95/Qwen3-8B/copypaste/prompt_reasoning_with_copypaste-1765148604.json"
    with open(path) as f:
        data = json.load(f)
    info = data["info"]
    data = data["data"]
    ...
    print(predict)
    answer, sfs = extract_answer_and_facts(predict)
    print("----" * 10)
    print(answer)
    print(sfs)

...
# VLLM_DEVICES="0,1"
VLLM_SERVED_MODEL_NAME="2_dense_answer_f1_warmup_qwen_3_4b_instruct_stage1" # vLLM服务模型名称
VLLM_SERVED_MODEL_PATH="/mnt/lustre/DATA/longyongchao/CopyPasteLRM/checkpoint/Qwen/Qwen3-4B-Instruct-2507-dense_answer_warmup-20251223004713/stage1/last" # vLLM服务模型路径
VLLM_MAX_L=32768
VLLM_MAX_S=128
VLLM_PORT=8124

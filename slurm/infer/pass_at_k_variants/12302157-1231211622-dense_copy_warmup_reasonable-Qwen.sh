...
VLLM_SERVED_MODEL_PATH="/mnt/lustre/DATA/longyongchao/CopyPasteLRM/checkpoint/12302157-1231211622-dense_copy_warmup_reasonable-Qwen/Qwen3-4B-Instruct-2507/stage2/checkpoint-322"
VLLM_MAX_L=32768
VLLM_MAX_S=16
VLLM_PORT=8124

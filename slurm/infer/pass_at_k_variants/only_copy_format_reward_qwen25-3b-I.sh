...
# VLLM_DEVICES="0,1"
VLLM_SERVED_MODEL_NAME="12302157-0102002204-only_copy_format_q25_3b_I_reasonable" # vLLM服务模型名称
VLLM_SERVED_MODEL_PATH="/mnt/lustre/DATA/longyongchao/CopyPasteLRM/checkpoint/12302157-0102125841-only_copy_format_q25_3b_I_reasonable-Qwen/Qwen2.5-3B-Instruct/stage1/best"
VLLM_MAX_L=32768
VLLM_MAX_S=64
VLLM_PORT=8124

...
# VLLM_DEVICES="0,1"
VLLM_SERVED_MODEL_NAME="8_dense_copy_answer_f1_warmup_musique_reasonable_qwen_3_4b_instruct" # vLLM服务模型名称
VLLM_SERVED_MODEL_PATH="/mnt/lustre/DATA/longyongchao/CopyPasteLRM/checkpoint/V4-1230112607-dense_copy_answer_warmup_reasonable-Qwen/Qwen3-4B-Instruct-2507/stage2/checkpoint-565" # vLLM服务模型路径
VLLM_MAX_L=32768
VLLM_MAX_S=16
VLLM_PORT=8124

...
EXP_NAME=12302157-${timestamp}-only_copy_format_q25_7b_I_reasonable-${MODEL_NAME}
...
export REWARD_FUNCS="cplrm_format cplrm_copy_format "
export REWARD_FORMAT=0.5
export REWARD_COPY=0.5
export REWARD_WEIGHTS="${REWARD_FORMAT} ${REWARD_COPY}"
export SWANLAB_EXP_NAME="[1/1]-${EXP_NAME}"

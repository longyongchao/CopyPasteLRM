...
EXP_NAME=V4-${timestamp}-answer_copy_v3_q25_7b_I_reasonable-${MODEL_NAME}
...
# Stage1 Rewards
export CURRICULUM_PHASE="answer_only"
export REWARD_FUNCS="cplrm_format cplrm_length cplrm_answer_copy"

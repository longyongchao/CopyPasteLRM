...
export BATCH_SIZE=8
export NUM_GENERATIONS=8 # 要求是 RLHF_NPROC_PER_NODE * BATCH_SIZE 的整数倍
export RLHF_DATASET="Qwen3-4B-I_MusiQue_128_without_2hop_reasonable_copypaste#200"

# 生成时间戳和实验名称
timestamp=$(date +%m%d%H%M%S)
EXP_NAME=${timestamp}-combined_25_3b_I_reasonable-${MODEL_NAME}
...
# SwanLab 配置
export SWANLAB_EXP_NAME="将事实复制和答案挂钩-并加入复制错误惩罚(Q25-3B-I)_v2_beta降低10倍_只抽样200数据"
